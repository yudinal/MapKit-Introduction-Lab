...
//    return [
//      Location(schoolName: "Pursuit", overviewParagraph: "We train adults with the most need and potential to get hired in tech, advance in their careers, and become the next generation of leaders in tech.", coordinate: CLLocationCoordinate2D(latitude: 40.74296, longitude: -73.94411), imageName: "team-6-3"),
...
//    let region = CLCircularRegion(center: location.coordinate, radius: 3200, identifier: identifier)
